...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'facebook_app_secret') !!}">
        {!! Form::label('facebook_app_secret', 'Facebook App Secret', ['class' => 'bold']) !!}                    
        {!! Form::text('facebook_app_secret', null, array('class'=>'form-control', 'id'=>'facebook_app_secret', 'placeholder'=>'Facebook App Secret')) !!}
