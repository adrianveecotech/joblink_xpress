...
Route::post('email-to-friend/{job_slug}', 'ContactController@emailToFriendPost')->name('email.to.friend.post');
...
Route::post('report-abuse/{job_slug}', 'ContactController@reportAbusePost')->name('report.abuse.post');
...
Route::post('report-abuse-company/{company_slug}', 'ContactController@reportAbuseCompanyPost')->name('report.abuse.company.post');
